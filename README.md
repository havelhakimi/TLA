...
Implementation for the ECML-PKDD 2024 accepted paper "Modeling Text-Label Alignment for Hierarchical Text Classification" [arxiv](https://arxiv.org/abs/2409.00788) [pdf](https://link.springer.com/chapter/10.1007/978-3-031-70365-2_10) 
## Requirements
- Python >= 3.6
- torch >= 1.6.0
- transformers >= 4.2.1
