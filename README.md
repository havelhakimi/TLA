...
- After obtaining the dataset, run the scripts in the folder `preprocess` for each dataset separately to obtained tokenized version of dataset and the related files. These will be added in the `data\x` folder where x is the name of dataset with possible choices as: wos, rcv and nyt.
