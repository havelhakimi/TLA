...
parser.add_argument('--graph_type', type=str, default='GPA',choices=['GPA','graphormer','GAT', 'GCN'], help='graph type')
...
if __name__ == '__main__':
    ...
    #data_path='/scratch/prashant1.iitr/ashish/LHA_WOS/pyscript/'
